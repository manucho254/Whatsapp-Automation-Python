...
label=Label(root, text="Phone Number: Format [+]",font=10 ,fg="white", bg="black")
...
#time
label=Label(root,text="Set Time:24/hr clock system", font=20,fg="white", bg="black" )
label.grid(row=1, padx=10, pady=10)
label.place(x = 10,
          y = 240)
...
send = Button(root, font="30" ,width=40, text="Send" , fg="green", bg="black", command=whatsup)
send.grid(row=3, column=1, padx=10, pady=10)
send.place(x = 15,
          y = 310)
if send == True:
   messagebox.showinfo("Whatsup message", "Succesfully sent")
